...
const SelectableChoice: React.FC<SelectableChoiceProps> = ({
  ...
  <button
    ...
    className={[
      'group min-h-11 min-w-11 border border-transparent shadow-sm',
      ...
      selected
        ? 'bg-emerald-50 text-emerald-950 ring-1 ring-inset ring-emerald-300 hover:bg-emerald-100'
        : 'bg-white text-slate-700 hover:bg-sky-50/70',
      className,
    ].join(' ')}
  >
    {children}
