...
export interface ResultReportBatchDetailDependencies {
...
export async function handleGetResultReportBatchDetail(
  request: Request,
  env: Env,
  batchId: string,
  injected?: ResultReportBatchDetailDependencies,
): Promise<Response> {
